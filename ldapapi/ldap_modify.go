...
func (api *LdapApi) uidsStringToDnSlice(valueString string) ([]string, error) {
	values := SplitAttributeValues(valueString)
...
func (api *LdapApi) uidsVerifyWithDnCache(valueString string) ([]string, error) {
	values := SplitAttributeValues(valueString)
